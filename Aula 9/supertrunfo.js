...
var cartaGoku = {
    nome: "Son Goku",
    imagem:"https://kanto.legiaodosherois.com.br/w760-h398-gnw-cfill-q80/wp-content/uploads/2020/04/legiao_zxgICM4ujVLa.jpg.jpeg",
    atributos: {
        ataque: 95,
        defesa: 100,
        magia: 90
...
var cartaHomemAranha = {
    nome: "Homem Aranha",
    imagem: "https://img.elo7.com.br/product/zoom/1483425/painel-de-festa-homem-aranha-adesivo-marvel.jpg",
    atributos: {
        ataque: 88,
        defesa: 90,
        magia: 60
...
var cartaMaquina
var cartaJogador
var cartas = [cartaPaulo, cartaRafa, cartaGui, cartaLol, cartaNaruto, cartaHarry, cartaBatman, cartaMarvel, cartaGoku, cartaHomemAranha]
...
function jogar() {
    ...
    if (cartaJogador.superTrunfo == 1){
        htmlResultado = '<p class="resultado-final">Super Trunfo! Venceu</p>'
        pontosJogador++  
    }else if (cartaMaquina.superTrunfo == 1){
        htmlResultado = '<p class="resultado-final">Super Trunfo! Perdeu</p>'
        pontosMaquina++
    }
